...
const ALLOWED_INVOKE_CHANNELS = new Set<keyof IPCChannels>([
  ...
  'app:getVersion', 'app:getLocale', 'app:openSyncFolder', 'app:selectFolder', 'app:getStorageQuota', 'app:selectFile', 'app:openExternal', 'app:previewFile', 'app:selectSavePath',
